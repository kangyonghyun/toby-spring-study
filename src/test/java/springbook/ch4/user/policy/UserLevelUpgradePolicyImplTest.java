...
import springbook.ch4.user.service.UserPolicyService;
...
@ContextConfiguration("/jdbctemplatepolicy.xml")
class UserLevelUpgradePolicyImplTest {
    @Autowired
    UserPolicyService userService;
